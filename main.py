...
P = 1  # Power[W]
scattering_number_of_iterations = 4
rho = 360*10e1 # Coordinates for the rays hitting the sphere
...
GeneratingOneImage(particle_center_x, particle_center_y, particle_center_z, R,P,rho, nm, nP,pol_X, pol_Y, pol_Z, pol_Vx, pol_Vy, pol_Vz,resolution,lens_size_x,lens_size_y,scattering_number_of_iterations)
